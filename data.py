...
## TODO: understand how the data loader setup works
# Currently, dataloader has three variables: x, y, and len for each datapoint (graph) in the batch
# x:
# y:
# len: the number of nodes in the graph
#
# We need to add a 4th - the labeling variable Z for the graph
#
# max_prev_node is the maximum number of previous nodes to consider (maximum frontier size M), I believe (confirm?)
