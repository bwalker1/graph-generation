...
if __name__ == '__main__':
    ...
    if 'GraphRNN_VAE_conditional' in args.note:
        ...
        rnn = GRU_plain(input_size=args.max_prev_node, embedding_size=args.embedding_size_rnn,
                        hidden_size=args.hidden_size_rnn, num_layers=args.num_layers, graph_embedding_size=graph_embedding_size, has_input=False,concat=args.concat,
    ...
    if args.make_graph_list:
        if not args.train:
            ...
            if args.concat:
                fname = re.sub("\.dat", "_concat.dat",fname)
