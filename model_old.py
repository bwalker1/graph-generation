'''
This file contains code from the original (Jiaxuan You) model.py file that is not used in our version of the auto-encoder.
Going forward if it is not needed it can probably be trimmed from the project.
'''
